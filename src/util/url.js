...
export const skipScheme = (scheme, isOpenNewTab) => {
    ...
    const url = {
        ...
        // 联报课详情页
        linkClassDetail: `/detail/comboCourse/${linkClazzNumber}${cellClazzNumbers ? `/${cellClazzNumbers}` : ''}${
            subclazzNumbers ? `/${subclazzNumbers}` : ''
        }`,

        //  联报课订单详情页
        goBuyLinkClazz: `/student/submitLinkOrder/${linkClazzNumber}/${cellSubclazzNumbers}/${cellClazzNumbers}`,
